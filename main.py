		...
		try:
			...
			if text == "/start":
				...
				*Features* - \n\
				...
				message = "*{}*\n*Location* : {}\n*Established* : {}\n*Rankings* : {}*Admission Exams* : {}\n*Courses Offered* : {}\n*Departments* : \n{}[Website]({}), [Wikipedia]({}), [Google map Location](https://maps.google.com/?q={})\
				".format(text, i_obj["location"], i_obj["established"], msg_rank, i_obj["admission_process"], i_obj["courses_offered"], msg_dept, i_obj["website"], i_obj["wiki_link"],text)
				send_message(message, chat)
